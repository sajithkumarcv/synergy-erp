...
const PostRtvModal = ({ rtv, onClose, onSubmit }) => {
    ...
    return (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.4)', zIndex: 1100, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ background: '#fff', borderRadius: 10, padding: '28px 32px', width: 420, boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}>
                <h3 style={{ margin: '0 0 4px', fontSize: 15, color: '#1e293b' }}>Post Return to Vendor</h3>
                <p style={{ margin: '0 0 18px', fontSize: 12, color: '#64748b' }}>
                    {rtv.rtvNumber} — posting will create stock <strong>OUT</strong> entries and cannot be undone.
                </p>
                ...
                <div style={{ marginBottom: 12 }}>
                    ...
                    <textarea
                        ...
                        placeholder="e.g. Over-delivery correction, damaged goods return…"
                        autoFocus
